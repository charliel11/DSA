...
class LFUCache {
  std::unordered_map<int, std::list<int>> freqListKeyMap; // freq->list<key>;
  std::unordered_map<int, int> keyFreqMap;                // key->freq;
  std::unordered_map<int, int> keyValueMap;               // key->value;
  int _capacity;
  int _size;
  int _minFreq;
